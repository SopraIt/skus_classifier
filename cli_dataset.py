...
class CLI:
    ...
    def _parser(self):
        ...
        parser.add_argument('-c', '--cutoff',
                            ...
                            type=float,
                            help=f'a float value indicating the cutoff percentage of the transformations to be applied, default to {training.Augmenter.CUTOFF} (about 80 transformations per image)')
